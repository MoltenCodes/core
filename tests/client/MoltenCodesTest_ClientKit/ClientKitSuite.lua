...
manifest:Test(
    ...
    function(ctx)
        ...
        ctx:Log(
            "title " .. describe(snapshot.title) .. " (the client answered " .. titleSource .. ")"
        )
        ctx:Log(
            "notes " .. describe(snapshot.notes) .. " (the client answered " .. notesSource .. ")"
        )
