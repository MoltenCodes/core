...
describe("TestKit error levels", function()
  ...
  it("points context and matcher errors, and matcher failures, at the test's own line", function()
    ...
    add("replace arguments", "TestKit.Context:Replace target must be a table", function(ctx, mark)
      mark()
    ...
    add("pattern", "TestKit.Matcher:ToRaise pattern must be a non-empty string", function(ctx, mark)
      mark()
