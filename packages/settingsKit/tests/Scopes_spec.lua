...
describe("SettingsKit scopes", function()
  ...
  it(
    ...
    function()
      ...
      TestEnv.expectErrorContaining('UnitFactionGroup("player") returned no faction', function()
        return db.faction
      end)
    end
  )
  ...
  it("refuses OnChange for an undeclared or unavailable scope", function()
    ...
    local db = SettingsKit:Open("MyAddonDB", { profile = valueSchema(), faction = valueSchema() })
