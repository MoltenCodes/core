...
describe("SettingsKit:Open", function()
  ...
  it("refuses a saved variable that is not a table", function()
    ...
    TestEnv.expectErrorContaining("SettingsKit:Open MyAddonDB must be a table or nil", function()
      SettingsKit:Open("MyAddonDB", schema())
    end)
  end)
  ...
  it("refuses a section that is not a table", function()
    ...
    TestEnv.expectErrorContaining("SettingsKit:Open MyAddonDB.profiles must be a table", function()
      SettingsKit:Open("MyAddonDB", schema())
    end)
  end)
  ...
  it("refuses malformed options", function()
    ...
    TestEnv.expectErrorContaining("options.defaultProfile must be a non-empty string", function()
  ...
  it("refuses a saved-variable name that is not an identifier", function()
    TestEnv.expectErrorContaining("savedVariable must be the name of a saved variable", function()
