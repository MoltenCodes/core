...
| `Bootstrap_spec.lua` | duplicate loading, Registry publication, dispatch repair, in-place upgrades, revision 16, limits and the sentinel carried across upgrades from revision 13 and to a newer revision, a revision-14 provider resolving unchecked, a contract kept under a newer revision, and the upgrade from revision 15 |
