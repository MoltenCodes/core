...
describe("SchedulerKit lanes", function()
  ...
  it("refuses bad arguments at the caller's line", function()
    ...
    expectErrorAtThisSpec("SchedulerKit:Lane retry.attempts must be a finite integer", function()
    ...
    expectErrorAtThisSpec("SchedulerKit.Lane:Submit scope must be a SchedulerKit scope", function()
