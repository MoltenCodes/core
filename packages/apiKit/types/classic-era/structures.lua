...
---@field equipmentSlot Enum.InventoryType
---@field level number
...
---@class TradeSkillReagentInfo
---@field reagentName? string
---@field reagentFileID? integer
---@field itemID number
---@field reagentCount number
---@field playerReagentCount number
...
---@class reforgeStatsInfo
---@field name string
---@field stat number
---@field statValue number

---@class srcReforgeStats
---@field name string
---@field stat number
---@field statReduction number
