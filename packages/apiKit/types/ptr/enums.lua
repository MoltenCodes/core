...
---@field AccountGetListRequestType Enum.AccountGetListRequestType
...
---@field AddSoulbindConduitReason Enum.AddSoulbindConduitReason
---@field AnimaDiversionNodeState Enum.AnimaDiversionNodeState
...
---@field AuctionHouseExtraColumn Enum.AuctionHouseExtraColumn
...
---@field BattleNetFriendLevel Enum.BattleNetFriendLevel
---@field BattleNetFriendTag Enum.BattleNetFriendTag
...
---@field BreakType Enum.BreakType
...
---@field CallingStates Enum.CallingStates
---@field CameraModeAspectRatio Enum.CameraModeAspectRatio
---@field CampaignState Enum.CampaignState
...
---@field CharCreateAnimTurnType Enum.CharCreateAnimTurnType
...
---@field ClickBindingInteraction Enum.ClickBindingInteraction
---@field ClickBindingType Enum.ClickBindingType
...
---@field CollationStrength Enum.CollationStrength
...
---@field CombatAudioAlertPulsePercentValues Enum.CombatAudioAlertPulsePercentValues
...
---@field CompanionRoleType Enum.CompanionRoleType
...
---@field ConquestProgressBarDisplayType Enum.ConquestProgressBarDisplayType
...
---@field CooldownViewerSound Enum.CooldownViewerSound
...
---@field CovenantAbilityType Enum.CovenantAbilityType
---@field CovenantSkill Enum.CovenantSkill
---@field CovenantType Enum.CovenantType
---@field CraftingOrderCustomerCategoryType Enum.CraftingOrderCustomerCategoryType
...
---@field CraftingOrderReagentsType Enum.CraftingOrderReagentsType
...
---@field CurrencyNameStyle Enum.CurrencyNameStyle
...
---@field CustomAuraButtonDispelTypeStealableFilter Enum.CustomAuraButtonDispelTypeStealableFilter
---@field CustomAuraButtonDispelTypeTextureStyle Enum.CustomAuraButtonDispelTypeTextureStyle
---@field CustomAuraButtonUpdateMode Enum.CustomAuraButtonUpdateMode
...
---@field DateTimeStyle Enum.DateTimeStyle
---@field DisableAccountProfilesFlags Enum.DisableAccountProfilesFlags
---@field DiscordAccountType Enum.DiscordAccountType
---@field DiscordDisplayNameType Enum.DiscordDisplayNameType
---@field DiscordGuildSettings Enum.DiscordGuildSettings
...
---@field EditModeLossOfControlSetting Enum.EditModeLossOfControlSetting
...
---@field EditModeRaidWarningSetting Enum.EditModeRaidWarningSetting
...
---@field EncounterLootDropRollState Enum.EncounterLootDropRollState
...
---@field ForbiddenAspect Enum.ForbiddenAspect
...
---@field GossipOptionRewardType Enum.GossipOptionRewardType
---@field GossipOptionStatus Enum.GossipOptionStatus
---@field GossipOptionUIWidgetSetTypes Enum.GossipOptionUIWidgetSetTypes
---@field GraphicsValidationResult Enum.GraphicsValidationResult
---@field GroupBuffItemFlags Enum.GroupBuffItemFlags
...
---@field HouseEditorPlayerType Enum.HouseEditorPlayerType
...
---@field HousingBlueprintContentType Enum.HousingBlueprintContentType
---@field HousingBlueprintFlag Enum.HousingBlueprintFlag
---@field HousingBlueprintType Enum.HousingBlueprintType
---@field HousingBlueprintUnmetRequirementFlags Enum.HousingBlueprintUnmetRequirementFlags
---@field HousingBudgetType Enum.HousingBudgetType
...
---@field HousingHouseScope Enum.HousingHouseScope
...
---@field HousingPetBehaviorType Enum.HousingPetBehaviorType
...
---@field ItemConversionFlags Enum.ItemConversionFlags
...
---@field LoadConfigResult Enum.LoadConfigResult
---@field LocaleTransform Enum.LocaleTransform
...
---@field LoginTicketLicenses Enum.LoginTicketLicenses
...
---@field MajorFactionFeatureAbility Enum.MajorFactionFeatureAbility
---@field MajorFactionType Enum.MajorFactionType
---@field MapCanvasPosition Enum.MapCanvasPosition
---@field MapIconUIWidgetSetType Enum.MapIconUIWidgetSetType
---@field MapOverlayDisplayLocation Enum.MapOverlayDisplayLocation
...
---@field NavigationState Enum.NavigationState
...
---@field PingMode Enum.PingMode
---@field PingResult Enum.PingResult
---@field PingSetTargetState Enum.PingSetTargetState
---@field PingSubjectType Enum.PingSubjectType
---@field PingTargetOption Enum.PingTargetOption
---@field PingTargetType Enum.PingTargetType
---@field PingTextureType Enum.PingTextureType
---@field PingTypeFlags Enum.PingTypeFlags
---@field PlayerChoiceFlags Enum.PlayerChoiceFlags
---@field PlayerChoiceLayout Enum.PlayerChoiceLayout
---@field PlayerChoiceRarity Enum.PlayerChoiceRarity
---@field PlayerChoiceResponseFlags Enum.PlayerChoiceResponseFlags
...
---@field PlayerDataElementAccountFlags Enum.PlayerDataElementAccountFlags
---@field PlayerDataElementCharacterFlags Enum.PlayerDataElementCharacterFlags
...
---@field PluralType Enum.PluralType
...
---@field ProfTraitPerkNodeFlags Enum.ProfTraitPerkNodeFlags
...
---@field ProfessionsSpecPathState Enum.ProfessionsSpecPathState
---@field ProfessionsSpecPerkState Enum.ProfessionsSpecPerkState
---@field ProfessionsSpecTabState Enum.ProfessionsSpecTabState
...
---@field QuestWatchType Enum.QuestWatchType
...
---@field RaidDispelOverlayType Enum.RaidDispelOverlayType
---@field RaidGroupDisplayType Enum.RaidGroupDisplayType
---@field RcoCloseReason Enum.RcoCloseReason
---@field RecentAlliesFriendTag Enum.RecentAlliesFriendTag
---@field RecentAllyPinResult Enum.RecentAllyPinResult
---@field RecipeRequirementType Enum.RecipeRequirementType
---@field RecruitAFriendFailure Enum.RecruitAFriendFailure
...
---@field ReputationSortType Enum.ReputationSortType
---@field RestrictPingsTo Enum.RestrictPingsTo
---@field RestrictionType Enum.RestrictionType
---@field RetroactiveDecorRewardFlags Enum.RetroactiveDecorRewardFlags
---@field RolodexContactMigrationResult Enum.RolodexContactMigrationResult
---@field RolodexContextLevelType Enum.RolodexContextLevelType
---@field RolodexDbFlags Enum.RolodexDbFlags
...
---@field RuneforgePowerFilter Enum.RuneforgePowerFilter
---@field RuneforgePowerState Enum.RuneforgePowerState
---@field ScreenLocationType Enum.ScreenLocationType
---@field ScreenshotSource Enum.ScreenshotSource
---@field ScriptBindingType Enum.ScriptBindingType
---@field ScriptObjectAccessRestriction Enum.ScriptObjectAccessRestriction
---@field ScriptObjectMetatable Enum.ScriptObjectMetatable
---@field ScriptObjectPartition Enum.ScriptObjectPartition
---@field ScriptObjectPropagationPath Enum.ScriptObjectPropagationPath
...
---@field SecondsFormatterRounding Enum.SecondsFormatterRounding
...
---@field SkinningState Enum.SkinningState
---@field SleevesGeoRange Enum.SleevesGeoRange
---@field SlotRegion Enum.SlotRegion
---@field SlotRegionMask Enum.SlotRegionMask
---@field SocialSystemType Enum.SocialSystemType
---@field SocialUIBlockType Enum.SocialUIBlockType
---@field SocialUIPresenceType Enum.SocialUIPresenceType
...
---@field SoulbindConduitFlags Enum.SoulbindConduitFlags
---@field SoulbindConduitInstallResult Enum.SoulbindConduitInstallResult
---@field SoulbindConduitTransactionType Enum.SoulbindConduitTransactionType
---@field SoulbindConduitType Enum.SoulbindConduitType
---@field SoulbindNodeState Enum.SoulbindNodeState
...
---@field SpellBookSkillLineIndex Enum.SpellBookSkillLineIndex
...
---@field StatusBarRenderMode Enum.StatusBarRenderMode
...
---@field SubscriptionInterstitialResponseType Enum.SubscriptionInterstitialResponseType
---@field SubscriptionInterstitialType Enum.SubscriptionInterstitialType
---@field SummonReason Enum.SummonReason
---@field SummonStatus Enum.SummonStatus
---@field SuperTrackingMapPinType Enum.SuperTrackingMapPinType
...
---@field TieredEntranceRewardType Enum.TieredEntranceRewardType
---@field TieredEntranceTierFlag Enum.TieredEntranceTierFlag
...
---@field TrackedSpellsResult Enum.TrackedSpellsResult
---@field TradeskillOrderDuration Enum.TradeskillOrderDuration
---@field TradeskillOrderRecipient Enum.TradeskillOrderRecipient
---@field TradeskillOrderStatus Enum.TradeskillOrderStatus
---@field TradeskillRecipeType Enum.TradeskillRecipeType
---@field TradeskillRelativeDifficulty Enum.TradeskillRelativeDifficulty
---@field TradeskillSlotDataType Enum.TradeskillSlotDataType
...
---@field UIFrameType Enum.UIFrameType
...
---@field UnitAuraSoundTrigger Enum.UnitAuraSoundTrigger
...
---@field VisualAlertType Enum.VisualAlertType
---@field VoiceChannelErrorReason Enum.VoiceChannelErrorReason
...
---@field WeatherType Enum.WeatherType
...
---@field WorldQuestQuality Enum.WorldQuestQuality
...
---@enum Enum.BreakType
Enum.BreakType = {
    ---Locate extended grapheme cluster boundaries, which are treated as user-perceived
    ---character units.
    Character = 0,
    ---Locate word boundaries for selection, search, and whole-word operations, including locale
    ---dictionary support where available.
    Word = 1,
    ---Locate sentence boundaries while handling cases such as periods in numbers or
    ---abbreviations and trailing punctuation.
    Sentence = 2,
    ---Locate positions where text can wrap, using Unicode line-breaking rules that handle
...
Enum.CollationStrength = {
    ---Compare base-character differences and ignore accents, case, and later collation levels.
    Primary = 0,
    ---Compare accent or diacritic differences after base characters match, while ignoring
    ---tertiary differences such as case.
    Secondary = 1,
    ---Compare case, letter variants, and similar tertiary differences after primary and
    ---secondary differences match.
    Tertiary = 2,
    ---Distinguish punctuation, whitespace, symbols, or Japanese Hiragana/Katakana differences
    ---after the first three levels match.
    Quaternary = 3,
    ---Use NFD Unicode code point order as a final tie-breaker after all other collation levels
    ---match.
    Identical = 4,
}
...
---@enum Enum.CombatAudioAlertPulsePercentValues
Enum.CombatAudioAlertPulsePercentValues = {
    Off = 0,
    Under90Percent = 1,
    Under80Percent = 2,
    Under70Percent = 3,
...
---@enum Enum.CurrencyNameStyle
Enum.CurrencyNameStyle = {
    ---A symbolic name for a currency, such as '$' for USD.
    Symbol = 0,
    ---The shortest narrow currency symbol, such as '$' instead of 'US$' for USD in en-CA.
    NarrowSymbol = 1,
    ---The long name for a currency, such as 'US Dollar' for USD.
    Long = 2,
    ---The formal currency symbol is similar to the regular currency symbol, but it always takes
    ---the form used in formal settings such as banking; for example, 'NT$' instead of '$' for
    ---TWD in zh-TW.
    FormalSymbol = 3,
    ---The variant symbol for a currency is an alternative symbol that is not necessarily as
...
Enum.CustomAuraButtonUpdateMode = {
    ---Applies a newly assigned aura, resetting presentation state rather than transitioning
    ---from the previous aura.
    Assignment = 0,
...
---@enum Enum.DateTimeStyle
Enum.DateTimeStyle = {
    ---Do not include this date or time portion in the formatter.
    None = 0,
    ---Use the shortest locale format, generally numeric, such as 12/13/52 or 3:30pm.
    Short = 1,
    ---Use a longer locale format than Short, such as abbreviated month names for dates.
    Medium = 2,
    ---Use a longer locale format with fuller names or time fields than Medium.
    Long = 3,
    ---Use the most completely specified locale format, such as weekday, era, or time zone when
    ---applicable.
    Full = 4,
}
...
Enum.ForbiddenAspect = {
    ---Restricts resetting this object to a default state. Implied automatically when any other
    ---forbidden aspect is set.
    SetToDefaults = 1,
    ---Restricts querying, replacement, or hooks of scripts on this object.
    ScriptBindings = 2,
    ---Restricts execution of all scripts for this object. Propagates to any children of this
    ---object.
    UntrustedScriptExecution = 4,
    ---Restricts execution of layout scripts (eg. OnSizeChanged) for this object. Propagates to
    ---any children of this object, and anything anchored to to this object.
    ...
    ---Forces propagation of mouse and keypress input for this object. Propagates to any
    ---children.
    ...
    ChangeParent = 1024,
    ---Restricts APIs that set the texture on a texture object.
    SetTexture = 2048,
    ---Restricts APIs that query texture rotation.
    QueryRotation = 4096,
    ---Restricts APIs that query the progress or state of animations.
    QueryAnimationProgress = 8192,
    ---Restricts APIs that add animations to animation groups.
    AddAnimations = 16384,
}
...
---@enum Enum.LocaleTransform
Enum.LocaleTransform = {
    ---Canonicalizes the locale identifier into ICU's canonical locale ID form.
    Canonicalize = 0,
    ---Adds likely script and region subtags according to CLDR likely-subtags data.
    AddLikelySubtags = 1,
    ---Minimizes script and region subtags according to CLDR likely-subtags data.
    RemoveLikelySubtags = 2,
    ---Gets the language code from the locale identifier.
    Language = 3,
    ---Gets the script code from the locale identifier.
    Script = 4,
    ---Gets the region code from the locale identifier.
    Region = 5,
    ---Gets the variant code from the locale identifier.
    Variant = 6,
    ---Gets the parent locale identifier.
    ParentLocale = 7,
}
...
---@enum Enum.NumberStyle
Enum.NumberStyle = {
    ---Use normal decimal number format for the locale.
    Decimal = 0,
    ---Use decimal formatting with zero minimum and maximum fraction digits in this wrapper.
    Integer = 1,
    ---Use percent number format for the locale.
    Percent = 2,
    ---Use generic currency format with a currency symbol and non-accounting minus-sign
    ---negatives.
    Currency = 3,
}
...
---@enum Enum.PlayerDataElementAccountFlags
Enum.PlayerDataElementAccountFlags = {
    Log = 1,
}

---@enum Enum.PlayerDataElementCharacterFlags
Enum.PlayerDataElementCharacterFlags = {
    Log = 1,
}
...
---@enum Enum.PluralType
Enum.PluralType = {
    ---Use plural rules for counted quantities, such as 1 file vs. 2 files.
    Cardinal = 0,
    ---Use plural rules for ordered values, such as 1st, 2nd, 3rd, and 4th.
    Ordinal = 1,
}
...
Enum.ScriptObjectAccessRestriction = {
    ---Denies access to this script object from tainted execution while aura information is
    ---secret.
...
Enum.ScriptObjectPropagationPath = {
    ---Propagation through script object hierarchy relationships, such as parent-child
    ---ownership.
    Hierarchy = 0,
    ---Propagation through layout dependency relationships, such as frames anchored relative to
    ---one another.
    Layout = 1,
}
...
Enum.StatusBarRenderMode = {
    ...
    Linear = 0,
    ---Render the status bar by driving the managed texture's radial progress fill percent
    ---instead of resizing the texture anchors.
    Radial = 1,
}
