...
---@field BattlePetAbilityFlag Enum.BattlePetAbilityFlag
---@field BattlePetAbilitySlot Enum.BattlePetAbilitySlot
---@field BattlePetAbilityTargets Enum.BattlePetAbilityTargets
---@field BattlePetAbilityTurnFlag Enum.BattlePetAbilityTurnFlag
---@field BattlePetAbilityTurnType Enum.BattlePetAbilityTurnType
---@field BattlePetAbilityType Enum.BattlePetAbilityType
---@field BattlePetAction Enum.BattlePetAction
---@field BattlePetBreedQuality Enum.BattlePetBreedQuality
---@field BattlePetEffectFlags Enum.BattlePetEffectFlags
---@field BattlePetEffectParamType Enum.BattlePetEffectParamType
---@field BattlePetEvent Enum.BattlePetEvent
---@field BattlePetNpcEmote Enum.BattlePetNpcEmote
---@field BattlePetNpcTeamFlag Enum.BattlePetNpcTeamFlag
---@field BattlePetOwner Enum.BattlePetOwner
---@field BattlePetSources Enum.BattlePetSources
---@field BattlePetSpeciesFlags Enum.BattlePetSpeciesFlags
---@field BattlePetStateFlag Enum.BattlePetStateFlag
---@field BattlePetTypes Enum.BattlePetTypes
---@field BattlePetVisualFlag Enum.BattlePetVisualFlag
---@field BattlePetVisualRange Enum.BattlePetVisualRange
---@field BattlepetDbFlags Enum.BattlepetDbFlags
---@field BattlepetDeletedReason Enum.BattlepetDeletedReason
---@field BattlepetSlotLockCheat Enum.BattlepetSlotLockCheat
...
---@field ChatMessagingLockdownReason Enum.ChatMessagingLockdownReason
...
---@field DungeonEncounterFlags Enum.DungeonEncounterFlags
---@field DungeonEncounterTriggerType Enum.DungeonEncounterTriggerType
---@field DungeonEncounterXCreatureFlags Enum.DungeonEncounterXCreatureFlags
...
---@field EncounterEventFlags Enum.EncounterEventFlags
...
---@field HousingCatalogEntrySubtype Enum.HousingCatalogEntrySubtype
...
---@field PetbattleAuraStateFlags Enum.PetbattleAuraStateFlags
---@field PetbattleCheatFlags Enum.PetbattleCheatFlags
---@field PetbattleEffectFlags Enum.PetbattleEffectFlags
---@field PetbattleEffectType Enum.PetbattleEffectType
---@field PetbattleEnviros Enum.PetbattleEnviros
---@field PetbattleInputMoveMsgDebugFlag Enum.PetbattleInputMoveMsgDebugFlag
---@field PetbattleMoveType Enum.PetbattleMoveType
---@field PetbattlePboid Enum.PetbattlePboid
---@field PetbattlePetStatus Enum.PetbattlePetStatus
---@field PetbattlePlayer Enum.PetbattlePlayer
---@field PetbattlePlayerInputFlags Enum.PetbattlePlayerInputFlags
---@field PetbattleResult Enum.PetbattleResult
---@field PetbattleSlot Enum.PetbattleSlot
---@field PetbattleSlotAbility Enum.PetbattleSlotAbility
---@field PetbattleSlotResult Enum.PetbattleSlotResult
---@field PetbattleState Enum.PetbattleState
---@field PetbattleTrapstatus Enum.PetbattleTrapstatus
---@field PetbattleType Enum.PetbattleType
...
---@field RolodexContextIDType Enum.RolodexContextIDType
...
Enum.ChatMessagingLockdownReason = {
    ---Chat lockdown is active because the player is in an active and incomplete instance
    ---encounter.
    ActiveEncounter = 0,
    ---Chat lockdown is active because the player is in an active and incomplete Mythic Keystone
    ---or Challenge Mode map.
    ActiveMythicKeystoneOrChallengeMode = 1,
    ---Chat lockdown is active because the player is in an active and incomplete PvP match.
    ActivePvPMatch = 2,
}
...
Enum.HousingCatalogEntrySubtype = {
    Invalid = 0,
    ---Unowned entry, for displaying a catalog object in a static context
    Unowned = 1,
    ---Stack of owned instances that share specific modifications (ex: stack of red-dyed chairs)
    OwnedModifiedStack = 2,
    ---Stack of owned default instances of a record
