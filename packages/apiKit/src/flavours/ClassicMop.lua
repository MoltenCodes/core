-- MoltenCodes ApiKit: Mists of Pandaria Classic bindings (wow.classic.mop.api)
--
-- GENERATED FILE. Do not edit. Regenerate with `python3 -m tooling.api.generate`.
-- Source: Gethe/wow-ui-source@cde55d0033e89b246381385b2f063cd6c6047ef8 (classic),
-- client 5.5.4, build 69934, captured 2026-09-24.
--
...
if type(Registry) ~= "table" or rawget(Registry, "API") ~= 2 then
    error(
        "MoltenCodes ApiKit (Mists of Pandaria Classic bindings) requires Registry API 2 to be loaded first",
        2
    )
end
...
if type(getPackage) ~= "function" then
    error(
        "MoltenCodes ApiKit (Mists of Pandaria Classic bindings) requires a valid Registry API 2 facade",
        2
    )
end
...
then
    error(
        "MoltenCodes ApiKit (Mists of Pandaria Classic bindings) requires ApiKit API 1 to be loaded first",
        2
    )
end

ApiKit:RegisterFlavor("classic-mop", function(api, host)
    do
    ...
    do
        ...
        if source then
            ...
            target.getGlyphInfoByID = source.GetGlyphInfoByID
            target.getGlyphLink = source.GetGlyphLink
        end
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.isDraggingStairwell = source.IsDraggingStairwell
