-- MoltenCodes ApiKit: Beta bindings (wow.beta.api)
--
-- GENERATED FILE. Do not edit. Regenerate with `python3 -m tooling.api.generate`.
-- Source: Gethe/wow-ui-source@078d0cf7512bfc9c83c576ae83d14ef6a173ea3b (beta),
-- client 12.0.1, build 66220, captured 2026-09-24.
--
...
if type(Registry) ~= "table" or rawget(Registry, "API") ~= 2 then
    error("MoltenCodes ApiKit (Beta bindings) requires Registry API 2 to be loaded first", 2)
end

local getPackage = rawget(Registry, "Get")
if type(getPackage) ~= "function" then
    error("MoltenCodes ApiKit (Beta bindings) requires a valid Registry API 2 facade", 2)
end
...
then
    error("MoltenCodes ApiKit (Beta bindings) requires ApiKit API 1 to be loaded first", 2)
end

ApiKit:RegisterFlavor("beta", function(api, host)
    do
    ...
    do
        ...
        if source then
            ...
            target.getActionLossOfControlCooldown = source.GetActionLossOfControlCooldown
    ...
    do
        ...
        if source then
            ...
            target.getStringFromModifiers = source.GetStringFromModifiers
            target.getTutorialShown = source.GetTutorialShown
            target.makeModifiers = source.MakeModifiers
    ...
    do
        ...
        if source then
            ...
            target.getManagedContributionsForCreatureID =
                source.GetManagedContributionsForCreatureID
    ...
    do
        ...
        if source then
            ...
            target.fetchCurrencyDataFromAccountCharacters =
                source.FetchCurrencyDataFromAccountCharacters
            ...
            target.getMaxTransferableAmountFromQuantity =
                source.GetMaxTransferableAmountFromQuantity
            ...
            target.isCurrencyTransferTransactionDataReady =
                source.IsCurrencyTransferTransactionDataReady
    ...
    do
        ...
        if source then
            ...
            target.requestPartyEligibilityForDelveTiers =
                source.RequestPartyEligibilityForDelveTiers
    ...
    do
        ...
        if source then
            ...
            target.getTalentTreeTalentPointResearchInfo =
                source.GetTalentTreeTalentPointResearchInfo
    ...
    do
        ...
        if source then
            ...
            target.getActiveDelveGossip = source.GetActiveDelveGossip
            ...
            target.getGossipDelveMapID = source.GetGossipDelveMapID
    ...
    do
        ...
        if source then
            ...
            target.getFeaturedDecor = source.GetFeaturedDecor
    ...
    do
        local source = host.C_HousingPhotoSharing
        if source then
            local target = {}
            api.housingPhotoSharing = target
    ...
    do
        ...
        if source then
            ...
            target.getSetBonusesForSpecializationByItemID =
                source.GetSetBonusesForSpecializationByItemID
    ...
    do
        ...
        if source then
            ...
            target.getItemUpgradePvpItemLevelDeltaValues =
                source.GetItemUpgradePvpItemLevelDeltaValues
    ...
    do
        ...
        if source then
            ...
            target.doesActivePartyMeetPremadeLaunchCount =
                source.DoesActivePartyMeetPremadeLaunchCount
    ...
    do
        ...
        if source then
            ...
            target.getRenownRewardsForLevel = source.GetRenownRewardsForLevel
            target.hasMaximumRenown = source.HasMaximumRenown
            target.isMajorFactionHiddenFromExpansionPage =
                source.IsMajorFactionHiddenFromExpansionPage
            target.isWeeklyRenownCapped = source.IsWeeklyRenownCapped
    ...
    do
        ...
        if source then
            ...
            target.getObjectIconTextureCoords = source.GetObjectIconTextureCoords
    ...
    do
        ...
        if source then
            ...
            target.setNamePlateHitTestFrame = source.SetNamePlateHitTestFrame
    ...
    do
        ...
        if source then
            ...
            target.getInspectAzeriteItemEmpoweredChoices =
                source.GetInspectAzeriteItemEmpoweredChoices
    ...
    do
        ...
        if source then
            ...
            target.clearPerksActivitiesPendingCompletion =
                source.ClearPerksActivitiesPendingCompletion
    ...
    do
        ...
        if source then
            local target = {}
            api.ping = target
            target.getContextualPingTypeForUnit = source.GetContextualPingTypeForUnit
    ...
    do
        ...
        if source then
            ...
            target.clearPendingPingInfo = source.ClearPendingPingInfo
            ...
            target.getTargetWorldPing = source.GetTargetWorldPing
            target.getTargetWorldPingAndSend = source.GetTargetWorldPingAndSend
            target.sendPing = source.SendPing
    ...
    do
        ...
        if source then
            ...
            target.getContentDifficultyCreatureForPlayer =
                source.GetContentDifficultyCreatureForPlayer
            ...
            target.isPlayerInTimerunningHeroicWorldTier =
                source.IsPlayerInTimerunningHeroicWorldTier
    ...
    do
        ...
        target.getCombatRatingBonusForCombatRatingValue =
            host.GetCombatRatingBonusForCombatRatingValue
        ...
        target.getMaxCombatRatingBonus = host.GetMaxCombatRatingBonus
    ...
    do
        ...
        if source then
            ...
            target.shouldShowPointsReminderForSkillLine =
                source.ShouldShowPointsReminderForSkillLine
    ...
    do
        ...
        if source then
            ...
            target.getPVPActiveRatedMatchDeserterPenalty =
                source.GetPVPActiveRatedMatchDeserterPenalty
            ...
            target.getPersonalRatedSoloShuffleSpecStats =
                source.GetPersonalRatedSoloShuffleSpecStats
            ...
            target.joinRandomTrainingGround = source.JoinRandomTrainingGround
    ...
    do
        ...
        if source then
            ...
            target.questIgnoresAccountCompletedFiltering =
                source.QuestIgnoresAccountCompletedFiltering
    ...
    do
        ...
        if source then
            ...
            target.isUnselectedConduitPendingInSoulbind =
                source.IsUnselectedConduitPendingInSoulbind
    ...
    do
        ...
        if source then
            ...
            target.getMawPowerBorderAtlasBySpellID = source.GetMawPowerBorderAtlasBySpellID
            ...
            target.getSpellLossOfControlCooldown = source.GetSpellLossOfControlCooldown
    ...
    do
        ...
        if source then
            ...
            target.getSpellBookItemLossOfControlCooldown =
                source.GetSpellBookItemLossOfControlCooldown
    ...
    do
        ...
        if source then
            ...
            target.getProfessionNameForSkillLineAbility =
                source.GetProfessionNameForSkillLineAbility
    ...
    api.events = {
        ...
        catalogShopPmtImageDownloaded = "CATALOG_SHOP_PMT_IMAGE_DOWNLOADED",
    ...
    do
        ...
        target.battlePetAbilityFlag = source.BattlePetAbilityFlag
        target.battlePetAbilitySlot = source.BattlePetAbilitySlot
        target.battlePetAbilityTargets = source.BattlePetAbilityTargets
        target.battlePetAbilityTurnFlag = source.BattlePetAbilityTurnFlag
        target.battlePetAbilityTurnType = source.BattlePetAbilityTurnType
        target.battlePetAbilityType = source.BattlePetAbilityType
        target.battlePetAction = source.BattlePetAction
        target.battlePetBreedQuality = source.BattlePetBreedQuality
        target.battlePetEffectFlags = source.BattlePetEffectFlags
        target.battlePetEffectParamType = source.BattlePetEffectParamType
        target.battlePetEvent = source.BattlePetEvent
        target.battlePetNpcEmote = source.BattlePetNpcEmote
        target.battlePetNpcTeamFlag = source.BattlePetNpcTeamFlag
        target.battlePetOwner = source.BattlePetOwner
        target.battlePetSources = source.BattlePetSources
        target.battlePetSpeciesFlags = source.BattlePetSpeciesFlags
        target.battlePetStateFlag = source.BattlePetStateFlag
        target.battlePetTypes = source.BattlePetTypes
        target.battlePetVisualFlag = source.BattlePetVisualFlag
        target.battlePetVisualRange = source.BattlePetVisualRange
        target.battlepetDbFlags = source.BattlepetDbFlags
        target.battlepetDeletedReason = source.BattlepetDeletedReason
        target.battlepetSlotLockCheat = source.BattlepetSlotLockCheat
        ...
        target.chatMessagingLockdownReason = source.ChatMessagingLockdownReason
        ...
        target.dungeonEncounterFlags = source.DungeonEncounterFlags
        target.dungeonEncounterTriggerType = source.DungeonEncounterTriggerType
        target.dungeonEncounterXCreatureFlags = source.DungeonEncounterXCreatureFlags
        ...
        target.encounterEventFlags = source.EncounterEventFlags
        ...
        target.housingCatalogEntrySubtype = source.HousingCatalogEntrySubtype
        ...
        target.petbattleAuraStateFlags = source.PetbattleAuraStateFlags
        target.petbattleCheatFlags = source.PetbattleCheatFlags
        target.petbattleEffectFlags = source.PetbattleEffectFlags
        target.petbattleEffectType = source.PetbattleEffectType
        target.petbattleEnviros = source.PetbattleEnviros
        target.petbattleInputMoveMsgDebugFlag = source.PetbattleInputMoveMsgDebugFlag
        target.petbattleMoveType = source.PetbattleMoveType
        target.petbattlePboid = source.PetbattlePboid
        target.petbattlePetStatus = source.PetbattlePetStatus
        target.petbattlePlayer = source.PetbattlePlayer
        target.petbattlePlayerInputFlags = source.PetbattlePlayerInputFlags
        target.petbattleResult = source.PetbattleResult
        target.petbattleSlot = source.PetbattleSlot
        target.petbattleSlotAbility = source.PetbattleSlotAbility
        target.petbattleSlotResult = source.PetbattleSlotResult
        target.petbattleState = source.PetbattleState
        target.petbattleTrapstatus = source.PetbattleTrapstatus
        target.petbattleType = source.PetbattleType
        ...
        target.rolodexContextIDType = source.RolodexContextIDType
...
end, { version = "12.0.1", build = 66220 })
