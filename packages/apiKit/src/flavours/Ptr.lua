...
if type(getPackage) ~= "function" then
  error("MoltenCodes ApiKit (Public Test Realm bindings) requires a valid Registry API 2 facade", 2)
end
...
ApiKit:RegisterFlavor("ptr", function(api, host)
  ...
  do
    ...
    if source then
      ...
      target.hasRandomTrainingGroundArenaWinToday = source.HasRandomTrainingGroundArenaWinToday
