-- MoltenCodes ApiKit: Classic Era bindings (wow.classic.era.api)
--
-- GENERATED FILE. Do not edit. Regenerate with `python3 -m tooling.api.generate`.
-- Source: Gethe/wow-ui-source@33e177d9bf38d76d5c6c6e05d5da78db1899659a (classic_era),
-- client 1.15.9, build 69722, captured 2026-09-24.
--
...
if type(Registry) ~= "table" or rawget(Registry, "API") ~= 2 then
    error("MoltenCodes ApiKit (Classic Era bindings) requires Registry API 2 to be loaded first", 2)
end

local getPackage = rawget(Registry, "Get")
if type(getPackage) ~= "function" then
    error("MoltenCodes ApiKit (Classic Era bindings) requires a valid Registry API 2 facade", 2)
end
...
then
    error("MoltenCodes ApiKit (Classic Era bindings) requires ApiKit API 1 to be loaded first", 2)
end

ApiKit:RegisterFlavor("classic-era", function(api, host)
    do
    ...
    do
        ...
        if source then
            ...
            target.getActionLossOfControlCooldownDuration =
                source.GetActionLossOfControlCooldownDuration
    ...
    do
        ...
        if source then
            ...
            target.getAreaPOITimeLeft = source.GetAreaPOITimeLeft
            target.isAreaPOITimed = source.IsAreaPOITimed
        end
    end
    do
        local target = {}
        api.arenaTeam = target
        target.acceptArenaTeam = host.AcceptArenaTeam
        target.disband = host.ArenaTeamDisband
        target.inviteByName = host.ArenaTeamInviteByName
        target.leave = host.ArenaTeamLeave
        target.setLeaderByName = host.ArenaTeamSetLeaderByName
        target.uninviteByName = host.ArenaTeamUninviteByName
        target.declineArenaTeam = host.DeclineArenaTeam
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.cycleCharCustomization = source.CycleCharCustomization
            target.getAvailableCustomizations = source.GetAvailableCustomizations
            target.getBarbersChoiceCost = source.GetBarbersChoiceCost
            ...
            target.getCustomizationTypeInfo = source.GetCustomizationTypeInfo
            ...
            target.isValidCustomizationType = source.IsValidCustomizationType
            target.isViewingAlteredForm = source.IsViewingAlteredForm
            target.isViewingNativeSex = source.IsViewingNativeSex
            target.isViewingVisibleSex = source.IsViewingVisibleSex
    ...
    do
        ...
        if source then
            ...
            target.areHighResTexturesInstalled = source.AreHighResTexturesInstalled
    ...
    do
        ...
        if source then
            ...
            target.findBestCurrencyProductForNeededAmount =
                source.FindBestCurrencyProductForNeededAmount
    ...
    do
        ...
        if source then
            ...
            target.getChallengeBestTime = source.GetChallengeBestTime
            target.getChallengeCompletionInfo = source.GetChallengeCompletionInfo
            target.getChallengeGuildBestTimeInfo = source.GetChallengeGuildBestTimeInfo
            target.getChallengeMapRewardInfo = source.GetChallengeMapRewardInfo
            target.getChallengeModeMapTimes = source.GetChallengeModeMapTimes
            target.getChallengeRealmBestTimeInfo = source.GetChallengeRealmBestTimeInfo
            ...
            target.getNumChallengeMapRewards = source.GetNumChallengeMapRewards
            target.getNumMedals = source.GetNumMedals
            ...
            target.isChallengeModeEnabled = source.IsChallengeModeEnabled
            target.isChallengeModeResettable = source.IsChallengeModeResettable
            target.requestChallengeModeLeaderboard = source.RequestChallengeModeLeaderboard
    ...
    do
        ...
        if source then
            local target = {}
            api.chatInfo = target
            target.areOutgoingAddonChatMessagesRestricted =
                source.AreOutgoingAddonChatMessagesRestricted
    ...
    do
        ...
        if source then
            ...
            target.assignPlayersToTeamInCurrentInstance =
                source.AssignPlayersToTeamInCurrentInstance
    ...
    do
        ...
        if source then
            ...
            target.getContainerItemGems = source.GetContainerItemGems
            ...
            target.isBagSlotFlagEnabledOnOtherBankBags = source.IsBagSlotFlagEnabledOnOtherBankBags
    ...
    do
        local source = host.C_CraftInfo
        if source then
            local target = {}
            api.craftInfo = target
        end
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.getDyeColorForItem = source.GetDyeColorForItem
            target.getDyeColorForItemLocation = source.GetDyeColorForItemLocation
    ...
    do
        local source = host.C_Engraving
        if source then
            local target = {}
            api.engraving = target
            target.addCategoryFilter = source.AddCategoryFilter
            target.addExclusiveCategoryFilter = source.AddExclusiveCategoryFilter
            target.castRune = source.CastRune
            target.clearAllCategoryFilters = source.ClearAllCategoryFilters
            target.clearCategoryFilter = source.ClearCategoryFilter
            target.clearExclusiveCategoryFilter = source.ClearExclusiveCategoryFilter
            target.enableEquippedFilter = source.EnableEquippedFilter
            target.getCurrentRuneCast = source.GetCurrentRuneCast
            target.getEngravingModeEnabled = source.GetEngravingModeEnabled
            target.getExclusiveCategoryFilter = source.GetExclusiveCategoryFilter
            target.getNumRunesKnown = source.GetNumRunesKnown
            target.getRuneCategories = source.GetRuneCategories
            target.getRuneForEquipmentSlot = source.GetRuneForEquipmentSlot
            target.getRuneForInventorySlot = source.GetRuneForInventorySlot
            target.getRunesForCategory = source.GetRunesForCategory
            target.hasCategoryFilter = source.HasCategoryFilter
            target.isEngravingEnabled = source.IsEngravingEnabled
            target.isEquipmentSlotEngravable = source.IsEquipmentSlotEngravable
            target.isEquippedFilterEnabled = source.IsEquippedFilterEnabled
            target.isInventorySlotEngravable = source.IsInventorySlotEngravable
            target.isInventorySlotEngravableByCurrentRuneCast =
                source.IsInventorySlotEngravableByCurrentRuneCast
            target.isKnownRuneSpell = source.IsKnownRuneSpell
            target.isRuneEquipped = source.IsRuneEquipped
            target.refreshRunesList = source.RefreshRunesList
            target.setEngravingModeEnabled = source.SetEngravingModeEnabled
    ...
    do
        ...
        target.setTableSecurityOption = host.SetTableSecurityOption
    ...
    do
        ...
        if source then
            ...
            target.isHardcoreActive = source.IsHardcoreActive
            ...
            target.isSelfFoundAllowed = source.IsSelfFoundAllowed
    ...
    do
        ...
        if source then
            ...
            target.houseFinderRequestReservationAndPort =
                source.HouseFinderRequestReservationAndPort
            target.isHousingMarketCartFullRemoveEnabled =
                source.IsHousingMarketCartFullRemoveEnabled
            ...
            target.isInsideOwnHouse = source.IsInsideOwnHouse
    ...
    do
        ...
        if source then
            ...
            target.getCatalogCategoryAndSubcategoryNames =
                source.GetCatalogCategoryAndSubcategoryNames
    ...
    do
        ...
        if source then
            ...
            target.applyWallpaperToSelectedRoomComponent =
                source.ApplyWallpaperToSelectedRoomComponent
            target.cancelActiveEditing = source.CancelActiveEditing
    ...
    do
        ...
        if source then
            ...
            target.getNumFloors = source.GetNumFloors
    ...
    do
        ...
        if source then
            ...
            target.isDressableItem = source.IsDressableItem
    ...
    do
        ...
        if source then
            ...
            target.updateTurnStrafeBindingsForCharacter =
                source.UpdateTurnStrafeBindingsForCharacter
        end
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.validateRequiredPvpRatingForActivity =
                source.ValidateRequiredPvpRatingForActivity
        end
    end
    do
        local source = host.C_LFGListRoles
        if source then
            local target = {}
            api.lfgListRoles = target
            target.getRoles = source.GetRoles
            target.getSavedRoles = source.GetSavedRoles
            target.setRoles = source.SetRoles
        end
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.getActiveLossOfControlDataCountByUnit =
                source.GetActiveLossOfControlDataCountByUnit
    ...
    do
        ...
        if source then
            ...
            target.getNumIcons = source.GetNumIcons
    ...
    do
        ...
        if source then
            ...
            target.getBountySetIDForMap = source.GetBountySetIDForMap
    ...
    do
        ...
        if source then
            ...
            target.getSeasonTimesForMap = source.GetSeasonTimesForMap
    ...
    do
        ...
        if source then
            ...
            target.isXPUserDisabled = source.IsXPUserDisabled
    ...
    do
        ...
        target.confirmBarbersChoice = host.ConfirmBarbersChoice
        target.confirmBinder = host.ConfirmBinder
        target.confirmPetUnlearn = host.ConfirmPetUnlearn
    ...
    do
        ...
        if source then
            ...
            target.clearLocklistMap = source.ClearLocklistMap
            ...
            target.getHolidayBGInfo = source.GetHolidayBGInfo
            target.getHolidayBGLossRewards = source.GetHolidayBGLossRewards
            target.getHolidayBGRewards = source.GetHolidayBGRewards
            target.getLocklistMap = source.GetLocklistMap
            target.getLocklistMapName = source.GetLocklistMapName
            target.getOutdoorPvPWaitTime = source.GetOutdoorPvPWaitTime
            target.getRandomBGInfo = source.GetRandomBGInfo
            target.getRandomBGLossRewards = source.GetRandomBGLossRewards
            target.getRandomBGRewards = source.GetRandomBGRewards
            target.getRatedBGRewards = source.GetRatedBGRewards
            target.getSelectedBattlefieldIndex = source.GetSelectedBattlefieldIndex
            target.getWorldPVPAreaInfo = source.GetWorldPVPAreaInfo
            target.getWorldPvPWaitTime = source.GetWorldPvPWaitTime
            ...
            target.setLocklistMap = source.SetLocklistMap
            target.setPVP = source.SetPVP
            target.setSelectedBattlefieldByIndex = source.SetSelectedBattlefieldByIndex
            target.togglePVP = source.TogglePVP
        end
    end
    do
        local source = host.C_QuestChoice
        if source then
            local target = {}
            api.questChoice = target
            target.closeQuestChoice = source.CloseQuestChoice
            target.getQuestChoiceInfo = source.GetQuestChoiceInfo
            target.getQuestChoiceOptionInfo = source.GetQuestChoiceOptionInfo
            target.getQuestChoiceRewardCurrency = source.GetQuestChoiceRewardCurrency
            target.getQuestChoiceRewardFaction = source.GetQuestChoiceRewardFaction
            target.getQuestChoiceRewardInfo = source.GetQuestChoiceRewardInfo
            target.getQuestChoiceRewardItem = source.GetQuestChoiceRewardItem
            target.sendQuestChoiceResponse = source.SendQuestChoiceResponse
        end
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.getQuestInfo = source.GetQuestInfo
    ...
    do
        local source = host.C_Reforge
        if source then
            local target = {}
            api.reforge = target
            target.closeReforge = source.CloseReforge
            target.getDestinationReforgeStats = source.GetDestinationReforgeStats
            target.getNumReforgeOptions = source.GetNumReforgeOptions
            target.getReforgeItemInfo = source.GetReforgeItemInfo
            target.getReforgeItemStats = source.GetReforgeItemStats
            target.getReforgeOptionInfo = source.GetReforgeOptionInfo
            target.getSourceReforgeStats = source.GetSourceReforgeStats
            target.reforgeItem = source.ReforgeItem
            target.setReforgeFromCursorItem = source.SetReforgeFromCursorItem
        end
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.requestFactionParagonPreloadRewardData =
                source.RequestFactionParagonPreloadRewardData
        end
    end
    do
    ...
    do
        local source = host.C_Seasons
        if source then
            local target = {}
            api.seasons = target
            target.getActiveSeason = source.GetActiveSeason
            target.hasActiveSeason = source.HasActiveSeason
        end
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.setActiveSpecGroup = source.SetActiveSpecGroup
        end
    end
    do
        local target = {}
    ...
    do
        ...
        if source then
            ...
            target.getSpellLossOfControlCooldownDuration =
                source.GetSpellLossOfControlCooldownDuration
            target.getSpellLossOfControlCooldownInfo = source.GetSpellLossOfControlCooldownInfo
            target.getSpellMaxCumulativeAuraApplications =
                source.GetSpellMaxCumulativeAuraApplications
    ...
    do
        ...
        if source then
            ...
            target.hasPurchaseableProducts = source.HasPurchaseableProducts
            target.isEnabled = source.IsEnabled
        end
    end
    do
    ...
    do
        ...
        if source then
            ...
            target.getTradeSkillTexture = source.GetTradeSkillTexture
    ...
    do
        ...
        if source then
            ...
            target.getEquippedSlotOptionFromTransmogSlot =
                source.GetEquippedSlotOptionFromTransmogSlot
            ...
            target.getTransmogOutfitSlotForInventoryType =
                source.GetTransmogOutfitSlotForInventoryType
            target.getTransmogOutfitSlotFromInventorySlot =
                source.GetTransmogOutfitSlotFromInventorySlot
    ...
    do
        ...
        if source then
            ...
            target.getButtonHeaderWidgetVisualizationInfo =
                source.GetButtonHeaderWidgetVisualizationInfo
            target.getCaptureBarWidgetVisualizationInfo =
                source.GetCaptureBarWidgetVisualizationInfo
            ...
            target.getDoubleStateIconRowVisualizationInfo =
                source.GetDoubleStateIconRowVisualizationInfo
            target.getDoubleStatusBarWidgetVisualizationInfo =
                source.GetDoubleStatusBarWidgetVisualizationInfo
            target.getFillUpFramesWidgetVisualizationInfo =
                source.GetFillUpFramesWidgetVisualizationInfo
            target.getHorizontalCurrenciesWidgetVisualizationInfo =
                source.GetHorizontalCurrenciesWidgetVisualizationInfo
            target.getIconAndTextWidgetVisualizationInfo =
                source.GetIconAndTextWidgetVisualizationInfo
            ...
            target.getTextureAndTextRowVisualizationInfo =
                source.GetTextureAndTextRowVisualizationInfo
            ...
            target.getUnitPowerBarWidgetVisualizationInfo =
                source.GetUnitPowerBarWidgetVisualizationInfo
    ...
    do
        ...
        target.setPortraitTextureFromCreatureDisplayID =
            host.SetPortraitTextureFromCreatureDisplayID
        target.setUnitCursorTexture = host.SetUnitCursorTexture
        target.shouldKnowUnitHealth = host.ShouldKnowUnitHealth
    ...
    do
        ...
        if source then
            ...
            target.addPrivateAuraAppliedSound = source.AddPrivateAuraAppliedSound
            ...
            target.removePrivateAuraAppliedSound = source.RemovePrivateAuraAppliedSound
            ...
            target.triggerPrivateAuraShowDispelType = source.TriggerPrivateAuraShowDispelType
    ...
    do
        ...
        if source then
            ...
            target.getLocalPlayerActiveChannelMemberInfo =
                source.GetLocalPlayerActiveChannelMemberInfo
    ...
    api.events = {
        ...
        arenaRegistrarClosed = "ARENA_REGISTRAR_CLOSED",
        arenaRegistrarShow = "ARENA_REGISTRAR_SHOW",
        arenaRegistrarUpdate = "ARENA_REGISTRAR_UPDATE",
        arenaSeasonWorldState = "ARENA_SEASON_WORLD_STATE",
        arenaTeamInviteRequest = "ARENA_TEAM_INVITE_REQUEST",
        arenaTeamRosterUpdate = "ARENA_TEAM_ROSTER_UPDATE",
        arenaTeamUpdate = "ARENA_TEAM_UPDATE",
        artifactDigsiteComplete = "ARTIFACT_DIGSITE_COMPLETE",
        assistedCombatActionSpellCast = "ASSISTED_COMBAT_ACTION_SPELL_CAST",
        auctionBidderListUpdate = "AUCTION_BIDDER_LIST_UPDATE",
        ...
        auctionItemListUpdate = "AUCTION_ITEM_LIST_UPDATE",
        ...
        auctionOwnedListUpdate = "AUCTION_OWNED_LIST_UPDATE",
        ...
        confirmBarbersChoice = "CONFIRM_BARBERS_CHOICE",
        ...
        corpsePositionUpdate = "CORPSE_POSITION_UPDATE",
        craftClose = "CRAFT_CLOSE",
        craftShow = "CRAFT_SHOW",
        craftUpdate = "CRAFT_UPDATE",
        ...
        engravingModeChanged = "ENGRAVING_MODE_CHANGED",
        engravingTargetingModeChanged = "ENGRAVING_TARGETING_MODE_CHANGED",
        ...
        forgeMasterClosed = "FORGE_MASTER_CLOSED",
        forgeMasterItemChanged = "FORGE_MASTER_ITEM_CHANGED",
        forgeMasterOpened = "FORGE_MASTER_OPENED",
        forgeMasterSetItem = "FORGE_MASTER_SET_ITEM",
        ...
        glyphAdded = "GLYPH_ADDED",
        glyphRemoved = "GLYPH_REMOVED",
        glyphUpdated = "GLYPH_UPDATED",
        ...
        housingLayoutNumFloorsChanged = "HOUSING_LAYOUT_NUM_FLOORS_CHANGED",
        ...
        lfgListRoleUpdate = "LFG_LIST_ROLE_UPDATE",
        ...
        newAuctionUpdate = "NEW_AUCTION_UPDATE",
        ...
        petTalentUpdate = "PET_TALENT_UPDATE",
        ...
        playerTargetSetAttacking = "PLAYER_TARGET_SET_ATTACKING",
        ...
        previewPetTalentPointsChanged = "PREVIEW_PET_TALENT_POINTS_CHANGED",
        previewTalentPointsChanged = "PREVIEW_TALENT_POINTS_CHANGED",
        previewTalentPrimaryTreeChanged = "PREVIEW_TALENT_PRIMARY_TREE_CHANGED",
        ...
        questChoiceClose = "QUEST_CHOICE_CLOSE",
        questChoiceUpdate = "QUEST_CHOICE_UPDATE",
        ...
        superTrackedQuestChanged = "SUPER_TRACKED_QUEST_CHANGED",
        ...
        talentGroupRoleChanged = "TALENT_GROUP_ROLE_CHANGED",
        ...
        uniqueQuestChoiceUpdate = "UNIQUE_QUEST_CHOICE_UPDATE",
        ...
        unitPetTrainingPoints = "UNIT_PET_TRAINING_POINTS",
    ...
    do
        ...
        target.combatAudioAlertPlayerCastFormatValues =
            source.CombatAudioAlertPlayerCastFormatValues
        ...
        target.combatAudioAlertTargetCastFormatValues =
            source.CombatAudioAlertTargetCastFormatValues
        ...
        target.currencySource = source.CurrencySource
        ...
        target.editModePersonalResourceDisplaySetting =
            source.EditModePersonalResourceDisplaySetting
        ...
        target.editModeStatusTrackingBarSystemIndices =
            source.EditModeStatusTrackingBarSystemIndices
        ...
        target.neighborhoodInitiativeNeighborhoodTypes =
            source.NeighborhoodInitiativeNeighborhoodTypes
        ...
        target.neighborhoodInitiativesCompletionStates =
            source.NeighborhoodInitiativesCompletionStates
        ...
        target.reforgeFailedReason = source.ReforgeFailedReason
        ...
        target.scalingArmorType = source.ScalingArmorType
        ...
        target.transmogOutfitSlotOptionSheatheCategory =
            source.TransmogOutfitSlotOptionSheatheCategory
    ...
    do
        ...
        target.itemWeaponSubclassClassic = source.ITEM_WEAPON_SUBCLASS_CLASSIC
        target.itemWeaponSubclassConstants = source.ITEM_WEAPON_SUBCLASSConstants
        target.itemWeaponSubclassConstantsPreMists = source.ITEM_WEAPON_SUBCLASSConstants_PreMists
        ...
        target.petConstsPreWrath = source.PetConsts_PreWrath
        target.professionConsts = source.ProfessionConsts
        target.pvpInfoConsts = source.PvpInfoConsts
        target.questWatchConstsClassic = source.QuestWatchConsts_Classic
        target.questWatchConstsClassicPreWrath = source.QuestWatchConsts_ClassicPreWrath
...
end, { version = "1.15.9", build = 69722 })
