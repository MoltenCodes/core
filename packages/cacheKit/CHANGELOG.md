...
- 84 specs, including allocation guards, a 5,000-step property test against a naive LRU model, an in-place upgrade spec, and regression specs for repeated failing reads, a refused `ClearOn` registration and secret values.
