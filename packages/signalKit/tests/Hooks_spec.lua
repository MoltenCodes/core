...
describe("SignalKit onFirst and onLast hooks", function()
    ...
    describe("options", function()
        ...
        it("refuses a non-table and a non-function hook at the caller", function()
            ...
            expectRefusalAtCaller(
                "SignalKit:New options.onFirst must be a function or nil",
                function()
                    SignalKit:New({ onFirst = true })
                end
            )
            expectRefusalAtCaller(
                "SignalKit:New options.onLast must be a function or nil",
                function()
    ...
    describe("errors", function()
        ...
        it(
            "aborts the dispatch when onLast raises inside Fire, after a journal recorded it",
            function()
