...
describe("SignalKit journals", function()
  ...
  describe("History", function()
    ...
    it("never errors when the journal fires during a walk, and keeps positions in range", function()
      local journal = SignalKit:NewJournal(3)
    ...
    it("refuses a call without a journal receiver at the caller", function()
      ...
      expectRefusalAtCaller("SignalKit.Journal:History must be called on a journal", function()
