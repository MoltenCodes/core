...
describe("SignalKit secret values", function()
  ...
  it("refuses secret bus options before comparing them", function()
    ...
    expectRefusalAtCaller("SignalKit:Bus options.maxTopics must not be a secret value", function()
    ...
    expectRefusalAtCaller("SignalKit:Bus options.openTopics must not be a secret value", function()
