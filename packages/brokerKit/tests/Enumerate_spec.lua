...
describe("BrokerKit enumeration", function()
  ...
  describe("Get", function()
    ...
    it("refuses an invalid name at the caller", function()
      TestEnv.expectErrorContaining("BrokerKit:Get name must be a non-empty string", function()
        BrokerKit:Get(nil)
      end)
    end)
  end)
  ...
  describe("IsForeign", function()
    ...
    it("refuses anything that is not a broker object", function()
      TestEnv.expectErrorContaining("BrokerKit:IsForeign object must be a broker object", function()
        BrokerKit:IsForeign({})
      end)
      TestEnv.expectErrorContaining("BrokerKit:IsForeign object must be a broker object", function()
