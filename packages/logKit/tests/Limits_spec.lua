...
describe("LogKit limits", function()
  ...
  for _, case in ipairs(invalidValues) do
    it("refuses " .. case.label .. " for maxSinks and maxLoggers and changes nothing", function()
      for _, name in ipairs({ "maxSinks", "maxLoggers" }) do
        ...
        assertReportedAt(
          line,
          "LogKit:SetLimits limits." .. name .. " must be a positive integer or LogKit.UNBOUNDED",
          ok,
          value
        )
      end
