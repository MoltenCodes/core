...
describe("LifecycleKit argument error positions", function()
  ...
  it("reports ForAddon argument errors at the caller's file and line", function()
    ...
    assert.is_false(ok)
    assert.are.equal(
      source .. ":" .. callLine .. ": LifecycleKit:ForAddon addonName must be a non-empty string",
      message
    )
  end)
  ...
  it("reports OnLoaded argument errors at the caller's file and line", function()
    ...
    assert.is_false(ok)
    assert.are.equal(
      source .. ":" .. callLine .. ": LifecycleKit.Instance:OnLoaded callback must be a function",
      message
    )
  end)
  ...
  it("reports OnReady argument errors at the caller's file and line", function()
    ...
    assert.is_false(ok)
    assert.are.equal(
      source .. ":" .. callLine .. ": LifecycleKit.Instance:OnReady callback must be a function",
      message
    )
  end)
  ...
  it("reports OnShutdown argument errors at the caller's file and line", function()
    ...
    assert.is_false(ok)
    assert.are.equal(
      source .. ":" .. callLine .. ": LifecycleKit.Instance:OnShutdown callback must be a function",
      message
    )
  end)
end)
...
describe("LifecycleKit combat and halt argument error positions", function()
  ...
  it("reports OnCombatStart and OnCombatEnd argument errors at the caller", function()
    ...
    assert.are.equal(
      source .. ":" .. endLine .. ": LifecycleKit.Instance:OnCombatEnd callback must be a function",
      endMessage
    )
  end)
  ...
  it("reports OnHalted and OnDependencyHalted argument errors at the caller", function()
    ...
    assert.are.equal(
      source .. ":" .. haltedLine .. ": LifecycleKit.Instance:OnHalted callback must be a function",
      haltedMessage
    )
  ...
  it("reports Halt argument errors at the caller", function()
    ...
    assert.is_false(ok)
    assert.are.equal(
      source .. ":" .. callLine .. ": LifecycleKit.Instance:Halt reason must be a non-empty string",
      message
    )
