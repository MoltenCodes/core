...
describe("MediaKit:Defaults", function()
  ...
  it("falls back to the first usable listed font on a client no built-in font covers", function()
    ...
    MediaKit:Register("font", "Pack Zhong", "Fonts\\Zhong.ttf", { scripts = { "cjkSimplified" } })
    MediaKit:Register("font", "Pack Alpha", "Fonts\\Alpha.ttf", { scripts = { "cjkSimplified" } })
  ...
  it("refuses more than 1024 consumers", function()
    ...
    TestEnv.expectErrorContaining("MediaKit:Defaults refuses more than 1024 consumers", function()
