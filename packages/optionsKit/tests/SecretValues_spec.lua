...
describe("OptionsKit and secret values", function()
  ...
  it("refuses a secret value at Set without writing it", function()
    TestEnv.expectErrorContaining("OptionsKit.Tree:Set value must not be a secret value", function()
  ...
  it("refuses a secret path before indexing with it", function()
    TestEnv.expectErrorContaining("OptionsKit.Tree:Get path must not be a secret value", function()
      tree:Get(secret)
    end)
    TestEnv.expectErrorContaining("OptionsKit.Tree:Set path must not be a secret value", function()
      tree:Set(secret, "x")
    end)
  end)

  it("refuses a secret addon name", function()
    TestEnv.expectErrorContaining("OptionsKit:Get addonName must not be a secret value", function()
