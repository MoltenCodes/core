...
- 104 specs, including allocation guards, pinned error levels, an in-place upgrade spec and a binding spec against a real SettingsKit database (pending when SettingsKit is not on the path).
