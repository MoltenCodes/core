...
describe("EventKit combat-log routing", function()
  ...
  describe("routing", function()
    ...
    it("does not deliver the current event to a wildcard listener connected during it", function()
    ...
    it("still fires a wildcard route dropped by a sub-event listener during the event", function()
      local wildcardCalls = 0
  ...
  describe("argument errors", function()
    it("rejects an invalid sub-event at the caller's line", function()
      expectCallerError("EventKit:ConnectCombatLog subEvent must be a non-empty string", function()
        EventKit:ConnectCombatLog("", noop)
      end)
      expectCallerError("EventKit:ConnectCombatLog subEvent must be a non-empty string", function()
    ...
    it("names the scope method in errors raised through a scope", function()
      ...
      expectCallerError("EventKit.Scope:ConnectCombatLog callback must be a function", function()
