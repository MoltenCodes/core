...
describe("EventKit secret values", function()
  ...
  it("refuses secret event names, sub-events and unit tokens before comparing them", function()
    ...
    expectRefusalAtCaller("EventKit:ConnectUnit unit token must not be a secret value", function()
      EventKit:ConnectUnit("UNIT_HEALTH", function() end, "SECRET_EVENT")
    end)
    expectRefusalAtCaller("EventKit:Coalesce events entry must not be a secret value", function()
  ...
  it("refuses secret option values before comparing them", function()
    ...
    expectRefusalAtCaller("EventKit:Coalesce intervalSeconds must not be a secret value", function()
