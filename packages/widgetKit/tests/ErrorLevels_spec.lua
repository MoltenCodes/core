...
describe("WidgetKit error levels", function()
    ...
    it("points facade argument errors at the caller", function()
        assertReportedAtCaller(
            "WidgetKit:RegisterType name must be a non-empty string",
            function(mark)
                mark()
        ...
        assertReportedAtCaller(
            "WidgetKit:Create must be called on the WidgetKit facade",
            function(mark)
                mark()
        ...
        assertReportedAtCaller(
            "WidgetKit:SetFocus must be called on a WidgetKit widget",
            function(mark)
                mark()
                WidgetKit:SetFocus({})
            end
    ...
    it("points base widget method errors at the caller", function()
        ...
        assertReportedAtCaller(
            "WidgetKit Slider:SetSliderValues step must be a number",
            function(mark)
                mark()
    ...
    it("points anchor, binding and rendering errors at the caller", function()
        ...
        assertReportedAtCaller(
            "WidgetKit.Binding:OnMoved callback must be a function",
            function(mark)
                mark()
                binding:OnMoved(nil)
            end
